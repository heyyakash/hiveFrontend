...
const Github = () => {
    ...
    console.log(repos)
    return (
        <Html transform position={[16, 10, 0]} rotation = {new THREE.Euler( 0, 5, 0, 'XYZ' )} className="w-[700px] overflow-scroll overflow-x-hidden py-3 px-5 h-[600px] rounded-xl bg-white/80 backdrop-blur-xl" occlude>
            <b>Github</b>
