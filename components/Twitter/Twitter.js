...
const Twitter = () => {
  ...
  return (
    <Html position={[-20,12,2]} rotation = {new THREE.Euler( 0, -6, 0, 'XYZ' )} transform occlude className = "w-[500px] flex flex-col bg-white/80 backdrop-blur-xl p-6 rounded-xl h-[500px] scroll-auto">
